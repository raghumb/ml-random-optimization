...
class ExperimentRunner:
    ...
    def experiment_rhc_1(self):
        init_state = None
        restart_lengths = np.arange(10, 1000, 50)
...
# GA(problem, 42, 10, 1000, 200, 0.1)
    ...
    def experiment_ga_4(self):
        pop_sizes = np.arange(200, 4000, 200)
...
# Mimic(problem, 42, 10, 1000, 200, 0.1)
    ...
    def experiment_optimal_rhc(self):
        ...
        diff = abs(end - start)
        print('time taken for RHC- FlipFlop: ' + str(diff))
    ...
    def experiment_optimal_sa(self):
        ...
        diff = abs(end - start)
        print('time taken for SA - FlipFlop: ' + str(diff))
    ...
    def experiment_optimal_ga(self):
        ...
        diff = abs(end - start)
        print('time taken for GA- FlipFlop: ' + str(diff))
    ...
    def experiment_optimal_mimic(self):
        ...
        diff = abs(end - start)
        print('time taken for Mimic - FlipFlop: ' + str(diff))                        
